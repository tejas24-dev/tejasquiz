...
function doSomething() {
   ...
   <body>
      ...
      <div>
         ...
         <h1 class="text-center text-white font-weight-bold text-uppercase bg-dark" > Welcome to Quiz Game </h1><br>
      <div class="container "><br>
         <div class="container">
         
            
            <div class=" col-lg-12 text-center">
               <h3> <a href="#" class="text-uppercase text-warning"> </a> You have 30 SECONDS to complete quiz </h3>
            </div>
            <br>
         ...
         <br>
         <footer>
            <h5 class="text-center"> MADE BY TEJAS </h5> 
         </footer>
      </div>
